...
public class Examples {
    public static ArrayList<UserProduct> getAllFood(){
        ...
        foodArray.add(new UserProduct(1,1,1,1,"name",1,50,100,  date));
        foodArray.add(new UserProduct(1,1,1,1,"name",1,70,100,  date));
        foodArray.add(new UserProduct(1,1,1,1,"name",1,80,100,  date));
        foodArray.add(new UserProduct(1,1,1,1,"name",1,40,100,  date));
        foodArray.add(new UserProduct(1,1,1,1,"name",1,20,100,  date));
        foodArray.add(new UserProduct(1,1,1,1,"name",1,50,100,  date));
        return foodArray;
    }
